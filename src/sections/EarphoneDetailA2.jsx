// src/sections/EarphoneDetailA2.jsx
import { useEffect, useRef } from "react";
import { useCart } from "../contexts/CartContext";
import gsap from "gsap";

export default function EarphoneDetailA2() {
  ...
  return (
    <section
      ...
      className="
        ...
        py-[22vh] bg-[#F6F8FB] overflow-hidden
      "
    >
      {/* BG */}
      <div
        ...
        className="
          absolute inset-0
          bg-gradient-to-b from-white via-[#e9edf2] to-[#f4f6f9]
          opacity-[0.94]
        "
      />
      ...
      <div className="relative z-10 max-w-[1280px] mx-auto px-14 flex items-center justify-between gap-20">
        ...
        <img
          ...
          className="
            w-[50%] max-w-[620px] A2
            drop-shadow-[0_40px_90px_rgba(0,0,0,0.14)]
          "
        />
      </div>
    </section>
